@echo off
set parentName=dropdown-with-math-field
...
(
echo include %filename%/dropdown-with-math-field%filename%.pug
)> newFile.pug
type dropdown-with-math-field.pug >> newFile.pug
move /Y newFile.pug  dropdown-with-math-field.pug
(
...
(
echo @import '%fileName%/dropdown-with-math-field%fileName%';
)>>dropdown-with-math-field.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=dropdown-with-math-field
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=dropdown-with-math-field%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/dropdown-with-math-field%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
